...
<link href='http://fonts.googleapis.com/css?family=Belgrano' rel='stylesheet' type='text/css'/>
	...
	<script src="template/js/jquery.tabify.js" type="text/javascript" charset="utf-8"></script>
					...
					<table id="rounded-corner">
						...
						<tbody>
							<tr class="odd">
								...
								<td>web design</td>
								<td>Alex</td>
								<td><a href="#"><img src="template/images/edit.png" alt=""
										title="" border="0" /></a></td>
								<td><a href="#"><img src="template/images/trash.gif" alt=""
										title="" border="0" /></a></td>
							</tr>
							<tr class="even">
								<td><input type="checkbox" name="" /></td>
					...
					<div class="toogle_wrap">
						...
						<div class="toggle_container">
							<p>
								...
								dolore magna aliqua. Ut enim ad minim veniam, quis nostrud
								exercitation ullamco laboris nisi ut aliquip ex ea commodo
								consequat.Lorem ipsum <a href="#">dolor sit amet</a>,
